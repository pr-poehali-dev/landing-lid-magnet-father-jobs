const IMG_DAD_LAPTOP = "https://cdn.poehali.dev/projects/8939daf8-2cf0-46fb-a1d6-2dbf2af6eff2/files/365bb519-255c-481b-97c1-99049877771d.jpg";
  ...
  return (
    <div className="min-h-screen bg-white font-golos overflow-x-hidden">
      ...
      <section className="relative pt-14 pb-10 px-5 max-w-2xl mx-auto text-center">
        ...
        >
          <span className="text-[#ffA500] font-montserrat font-700 text-xs tracking-widest uppercase">Бесплатный лид-магнит</span>
        </div>
        ...
        >
          ...
          <span className="relative inline-block">
            ...
            <span
              className="absolute -bottom-1 left-0 w-full h-3 bg-[#fff4e0] -z-0 rounded"
              style={{ bottom: "2px" }}
            />
          </span>
          <br />
        ...
        {/* Фото папы с ребёнком */}
        <div
          className="relative mb-10 opacity-0 animate-fade-in"
          style={{ animationDelay: "0.5s" }}
        >
          <div className="relative rounded-3xl overflow-hidden shadow-2xl max-h-72 sm:max-h-80">
            <img
              src={IMG_DAD_CHILD}
              alt="Папа с ребёнком"
      ...
      <section className="px-5 max-w-2xl mx-auto mb-10">
        <div className="bg-[#fffaf2] border border-[#ffe0a0] rounded-2xl p-6 sm:p-8">
          <h2 className="font-montserrat font-bold text-gray-900 text-lg mb-5">
            Что внутри:
          </h2>
      ...
      <section className="px-5 max-w-2xl mx-auto mb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <a
            href="#"
            className="group flex-1 flex items-center justify-center gap-3 bg-[#0077FF] hover:bg-[#0060cc] text-white font-montserrat font-bold text-base sm:text-lg py-5 px-6 rounded-2xl shadow-lg transition-all duration-200 hover:scale-[1.03] hover:shadow-xl"
          >
          ...
          <a
            href="#"
            className="group flex-1 flex items-center justify-center gap-3 bg-[#ffA500] hover:bg-[#e69400] text-white font-montserrat font-bold text-base sm:text-lg py-5 px-6 rounded-2xl shadow-lg transition-all duration-200 hover:scale-[1.03] hover:shadow-xl"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <p className="text-center text-gray-400 text-xs mt-5">
          🔒 Бесплатно · Без регистрации · Моментальный доступ
        </p>
      </section>

      {/* Footer */}
      <footer className="border-t border-gray-100 py-6 text-center">
        <p className="text-gray-300 text-xs font-golos">
          © 2026 · Все подработки проверены лично
        </p>
      </footer>
